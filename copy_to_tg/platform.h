...
static struct SW_HANDLE *const sw_ptr = CAST(struct SW_HANDLE *const, 0x01000000);
...
static struct LED_HANDLE *const led_ptr = CAST(struct LED_HANDLE *const, 0x02000000);
...
static struct PS2_HANDLE *const ps2_ptr = CAST(struct PS2_HANDLE *const, 0x03000000);
...
static struct HEX_HANDLE *const hex_ptr = CAST(struct HEX_HANDLE *const, 0x04000000);
...
static struct RX_HANDLE *const rx_ptr = CAST(struct RX_HANDLE *const, 0x05000000);
...
static struct TX_HANDLE *const tx_ptr = CAST(struct TX_HANDLE *const, 0x06000000);
...
static struct VGA_HANDLE vga = {CAST(uint8_t *const, 0x07000000), CAST(uint8_t *const, 0x07001000), CAST(uint8_t *const, 0x07002000)};
...
static struct TIMER_HANDLE *const timer_ptr = CAST(struct TIMER_HANDLE *const, 0x08000000);
...
//static struct SUPER_COLLIDER_HANDLE *const collider_ptr = CAST(struct SUPER_COLLIDER_HANDLE *const, 0xFF000000);
//static struct SUPER_COLLIDER_HANDLE        collider_obj = {0, 0, 0, 0, CAST(uint8_t *const, 0xFF000100)};
